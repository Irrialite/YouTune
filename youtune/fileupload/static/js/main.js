...
$(function () {
    ...
    $('#fileupload')
        .bind('fileuploadadd', function(e, data) {
            ...
            {
                var fetchingAlert = '<div class="alert"><button type="button" class="close" data-dismiss="alert">&times;</button><span>Fetching track info from last.fm. Please wait.</span></div>';
                $('#alertposition').append(fetchingAlert);
                ...
                reader.onload = function(e) {
                    ...
                    else
                    {
        	            ...
        	            $('input#id_tags').val("");
                        $(".alert span").text("This file doesn't have an ID3 tag. Please fill out the fields.");
                        scope.$apply();
                    }
                };
